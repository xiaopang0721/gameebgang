	...
	export class EbgangPageDef extends game.gui.page.PageDef {
		...
		static myinit(str: string) {
			...
			this["__needLoadAsset"] = [
				...
				Path_game_ebgang.ui_ebgang + "sk/ebg_0.sk",
				Path_game_ebgang.ui_ebgang + "sk/ebg_1.png",
				Path_game_ebgang.ui_ebgang + "sk/ebg_1.sk",
				Path_game_ebgang.ui_ebgang + "sk/ebg_2.png",
				Path_game_ebgang.ui_ebgang + "sk/ebg_2.sk",
				Path_game_ebgang.ui_ebgang + "sk/ebg_3.png",
				Path_game_ebgang.ui_ebgang + "sk/ebg_3.sk",
